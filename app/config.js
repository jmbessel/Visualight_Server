...
module.exports = function(app, exp, MongoStore) {
	...
	app.configure(function(){
		...
		app.use(exp.session({ secret: 'super-duper-secret-secret', maxAge: new Date(Date.now() + 3600000), store: new MongoStore({url:'mongodb://10.0.0.4/visualight'},function(){console.log('MongoStore Connected'.debug)}) }));
